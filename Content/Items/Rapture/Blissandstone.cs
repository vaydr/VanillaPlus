...
{
    public class Blissandstone : ModItem
    {
        public override string Texture => "Terraria/Images/Item_3272"; // Vanilla sandstone item

        private static readonly Color RaptureTint = Main.hslToRgb(0.12f, 0.6f, 0.75f);

        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            Texture2D texture = TextureAssets.Item[ItemID.Sandstone].Value;
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.Rapture.Blissandstone>();
        }
    }
}
